...
class App(customtkinter.CTk):
    ...
    def createSearchInterface(self):
        ...
        self.search_name_var = customtkinter.StringVar()
        self.search_numero_var = customtkinter.StringVar()
    ...
    def create_contact_modification_window(self, contact_index):
        ...
        name = self.contact_list[contact_index].get('nom')
        ...
        self.contact_modification_window.geometry("500x230")

        self.contact_modification_window.protocol("WM_DELETE_WINDOW", self.destroyAndRedraw)
        ...
        self.title_subWindow = customtkinter.CTkLabel(master=self.left_frame_subWindow, text=name, font=customtkinter.CTkFont(size=25, weight="bold"))
        ...
        self.cancel_changes_button = customtkinter.CTkButton(master=self.right_frame_subWindow, text='Cancel', width=60)
        self.cancel_changes_button.grid(row=1, column=1, padx=15, pady=15, sticky='es')
        
        self.accept_button_save_changes = customtkinter.CTkButton(self.right_frame_subWindow, text="Save",width=60, command=lambda:self.save_name_modification())
        self.accept_button_save_changes.grid(row=2, column=1, padx=15, pady=15, sticky='es')

    def destroyAndRedraw(self):
    ...
    def save_name_modification(self):
